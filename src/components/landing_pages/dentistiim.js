import base_preview from '@/images/base_previews/dentistiim.jpg'
    ...
    <>
      <div className="store__container">
        <div className="store-layout">
          ...
          <div className="store-content" style={{marginTop: 30}}>
            ...
            <div className="store-link">
              <div className="store-link-info">
                ...
                <div className="description">
                  <div className="block__heading">Instagram</div>
                  <div className="block__subheading">Our page</div>
                </div>
              </div>
              <button onClick={() => onClickLink(instagramLink, 'tripadvisor')} className="click-link-button">
                <div>Follow Us</div>
              </button>
            </div>
          </div>
